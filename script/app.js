...
pushBtn.addEventListener('click', () => {
  ...
  bash += "# IMPORTANT: Edit these with your GitHub info so contributions count\n";
  bash += 'echo "Enter your GitHub email:"\n';
  bash += 'read -p "> " GIT_EMAIL\n';
  bash += 'echo "Enter your GitHub username:"\n';
  bash += 'read -p "> " GIT_NAME\n';
